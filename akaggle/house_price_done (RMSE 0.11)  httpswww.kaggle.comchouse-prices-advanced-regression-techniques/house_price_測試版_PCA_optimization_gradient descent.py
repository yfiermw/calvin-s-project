...
def gradientDescent(X, y, theta, learning_rate_2, range_num):

for pca_num in np.arange(range_num):
    theta = theta - alpha * (1.0 / math.sqrt(pca_num+1)) * (X * theta - y )
    
return theta



#    rmse_history=pca_ratio*w_pca
theta = gradientDescent(pca_ratio, rmse_history, theta, alpha, range_num)
pca_ratio=theta*pca_ratio
...
# Start training, reset variables
