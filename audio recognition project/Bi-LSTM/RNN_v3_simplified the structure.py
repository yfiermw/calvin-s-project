...
#tf.nn.rnn_cell.BasicLSTMCell(n_hidden, forget_bias=1.0, state_is_tuple=True): n_hidden表示神经元的个数，
#forget_bias就是LSTM们的忘记系数，如果等于1，就是不会忘记任何信息。如果等于0，就都忘记。state_is_tuple默认就是True，官方建议用True
...
# =============================================================================
    ...
    layer_5 = tf.reshape(layer_5, [-1, batch_x_shape[0], n_character])
...
# 使用ctc loss计算损失
cost = tf.reduce_mean(ctc_ops.ctc_loss(targets, logits, seq_length))
